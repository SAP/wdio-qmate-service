...
const Session = function () {
  ...
  // use only as internal function
  this.loginWithUsernameAndPassword = async function (username, password = "super-duper-sensitive-pw", authenticator = ui5.common.authenticators.fioriForm, verify = false) {
