...
const Mockserver = function () {
  ...
  /**
    ...
    * @example await utilities.mockserver.waitForUi5ApplicationLoad(100);
    */
   ...
   * @example await utilities.mockserver.interactWithMockServer("path/to/project/localService/main/mockserver", fnCallback, oParams);
   */
  this.interactWithMockServer = async function (mockServerPath, fnCallback, oParams) {
    ...
    return await utilities.mockserver.waitForUi5ApplicationLoad();
  };
  ...
  * @example await utilities.mockserver.attachFunctionBefore("GET", "path/to/project/localService/main/mockserver", fnBeforeCallback, oParams);
  */
  ...
  * @param {Object} oParams - Additional parameters you would like to inject in your client script function
  * @example await utilities.mockserver.attachFunctionAfter("GET", "path/to/project/localService/main/mockserver",  fnAfterCallback);
  */
   ...
   * @example await utilities.mockserver.addNewRequest("GET","path/to/project/localService/main/mockserver", "*.Headers.*", "path/to/project/localService/main/mockdata/test.json", 200, true, JSON.stringify(msg));
   */
  this.addNewRequest = async function (method, mockServerPath, urlPathRegex, responseJsonPath, returnCode, isText, responseMessages, responseLocation) {
    ...
    await lib.mockServerActionInBrowser(function (mockserver, method, urlPathRegex, responseJsonPath, responseMessages, responseLocation, returnCode, isText, done) {
      ...
      var fnResponse = function (oXhr) {
        ...
        if (isNaN(parsedReturnCode)) { parsedReturnCode = 200; }
        if (isText && isText !== "false") {
 ...
 * @param {String} mockServerPath - The full path to your mockserver file [make sure you implemented getMockServer method in this file to return the mockserver instance].
 * @param {String} urlPathRegex - The url path regex to filter the requests
 * @example await utilities.mockserver.removeRequest("GET","path/to/project/localService/main/mockserver", "*.Headers.*");
 */
   ...
   * @param {String} responseMessages - Mocks the gw sap-message response messages [Don't forget to stringify your json before: JSON.stringify(msg)]
   * @param {String} responseLocation - Mocks the location response messages header
   * @example await utilities.mockserver.addOrOverrideRequest("GET","path/to/project/localService/main/mockserver", "*.Headers.*", "path/to/project/localService/main/mockdata/test.json", 200, true, JSON.stringify(msg));
   */
   ...
   * @param {String} mockServerPath - The full path to your mockserver file [make sure you implemented getMockServer method in this file to return the mockserver instance].
   * @example await utilities.mockserver.startMockServer("path/to/project/localService/main/mockserver");
   */
  ...
  /**
    ...
    * @example await utilities.mockserver.initMockServer("path/to/project/localService/main/mockserver", mockServerOptions);
    */
  ...
  /**
    ...
    * @param {String} mockServerPath - The full path to your mockserver file [make sure you implemented getMockServer method in this file to return the mockserver instance].
    * @example await utilities.mockserver.initApplication("path/to/project/localService/main/mockserver");
    */
  ...
  /**
    ...
    * @param {String} mockServerPath - The full path to your mockserver file [make sure you implemented getMockServer method in this file to return the mockserver instance].
    * @example await utilities.mockserver.stopMockServer("path/to/project/localService/main/mockserver");
    */
  ...
  /**
    ...
    * @example await utilities.mockserver.loadMockDataFile("path/to/project/mockData/myData.json", true);
    */
   ...
   * @example await utilities.mockserver.getEntitySetData("path/to/project/localService/main/mockserver", "Headers");
   */
  ...
  /**
    ...
    * @example await utilities.mockserver.setEntitySetData("path/to/project/localService/main/mockserver", "Headers", entries);
    */
