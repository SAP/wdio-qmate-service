...
describe("locator - getAll and catch error", function () {
  ...
  it("Execution and Verification", async function () {
    await expect(nonUi5.element.getAll("[class='sapMBtnBase sapMBtn sapMBtnInverted sapMDialogBeginButton sapMBarChild']", 4000))
      .rejects.toThrow("Function 'getAll' failed");
  });
});
