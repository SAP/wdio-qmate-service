  ...
  services: [
    ...
    ["static-server", {
      ...
      folders: [{
          ...
          path: path.resolve(__dirname, "../../website/waitForElements.html")
        },
        {
          mount: "/buttons.html",
          path: path.resolve(__dirname, "../../website/buttons.html")
        },
        {
          mount: "/checkBox.html",
          path: path.resolve(__dirname, "../../website/checkBox.html")
        },
        {
          mount: "/dropdown.html",
          path: path.resolve(__dirname, "../../website/dropdown.html")
        },
        {
          mount: "/forms.html",
          path: path.resolve(__dirname, "../../website/forms.html")
        },
        {
          mount: "/scrollPage.html",
          path: path.resolve(__dirname, "../../website/scrollPage.html")
        },
        {
          mount: "/hiddenAndVisible.html",
          path: path.resolve(__dirname, "../../website/hiddenAndVisible.html")
        },
        {
          mount: "/tables.html",
          path: path.resolve(__dirname, "../../website/tables.html")
        }
      ]
    }]
  ],
