...
describe("locator - getDisplayedElements by selector", function () {
  ...
  it("Execution", async function () {
    ...
    elements = await ui5.common.locator.getDisplayedElements(selector);
  });

  it("Verification", async function () {
    ui5.common.assertion.expectDefined(elements);
    ui5.common.assertion.expectDefined(elements.length);
  });
});
...
describe("locator - getDisplayedElements by wrong selector (unhappy case)", function () {
  ...
  it("Execution and Verification", async function () {
    ...
    await expect(ui5.common.locator.getDisplayedElements(selector))
...
describe("locator - getDisplayedElements by selector for invisible elements (unhappy case)", function () {
  ...
  it("Execution and Verification", async function () {
    ...
    await expect(ui5.common.locator.getDisplayedElements(selectorForInvisibleElements))
