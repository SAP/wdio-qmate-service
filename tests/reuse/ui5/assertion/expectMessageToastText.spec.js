...
describe("assertion - expectMessageToast - no message toast (unhappy case)", function () {
  ...
  it("Execution and Verification", async function () {
    ...
    await expect(ui5.assertion.expectMessageToastText(text, 3000))
...
describe("assertion - expectMessageToast", function () {
  ...
  it("Verification", async function () {
    await ui5.assertion.expectMessageToastText("Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy\r\n eirmod.", 3000);
    await ui5.assertion.expectMessageToastText("Lorem ipsum", 3000);
    await expect(ui5.assertion.expectMessageToastText("Wrong text", 3000))
      .rejects.toThrow(/Element with XPath/);
  });
});