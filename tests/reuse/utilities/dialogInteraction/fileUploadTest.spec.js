...
describe("dialogInteraction - uploadFiles", function () {
  ...
  it("Execution", async function () {
    ...
    await utilities.dialogInteraction.uploadFiles(files);
  });
  ...
  it("Verification", async function () {
    ...
    await ui5.common.locator.getDisplayedElement(selectorTest);
    await ui5.common.locator.getDisplayedElement(selectorTest2);
