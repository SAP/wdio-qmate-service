describe("authenticator (plain) - fiori", function () {
  ...
  it("Execution", async function () {
    await ui5.session.login("PURCHASER", "super-duper-sensitive-pw", false);
  });
...
describe("authenticator (plain) - loginFiori", function () {
  ...
  it("Execution", async function () {
    await ui5.session.loginFiori("PURCHASER", "super-duper-sensitive-pw", false);
  });
...
describe("authenticator (plain) - loginSapCloud", function () {
  ...
  it("Execution", async function () {
    await ui5.session.loginSapCloud("PURCHASER", "super-duper-sensitive-pw", false);
  });
