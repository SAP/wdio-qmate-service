describe("authenticator (plain) - fiori", function () {
  ...
  it("Execution", async function () {
    await ui5.common.session.login("PURCHASER", "Welcome1!", false);
  });
...
describe("authenticator (plain) - loginFiori", function () {
  ...
  it("Execution", async function () {
    await ui5.common.session.loginFiori("PURCHASER", "Welcome1!", false);
  });
...
describe("authenticator (plain) - loginSapCloud", function () {
  ...
  it("Execution", async function () {
    await ui5.common.session.loginSapCloud("PURCHASER", "Welcome1!", false);
  });
