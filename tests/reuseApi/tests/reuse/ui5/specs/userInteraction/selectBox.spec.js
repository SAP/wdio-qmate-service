...
describe("userInteraction - selectBox", function () {
  ...
  it("Execution", async function () {
    ...
    await ui5.common.userInteraction.selectBox(selector, actualValue, index);
  });

  it("Verification", async function () {
    expectedValue = "HT-1003";
    index = 0;
    await ui5.common.assertion.expectAttributeToBe(selector, "selectedKey", expectedValue, index);
  });
});
...
describe("userInteraction - selectComboBox use wrong selector", function () {
  ...
  it("Execution and Verification", async function () {
    ...
    actualValue = "HT-1003";
    index = 0;
    await expect(ui5.common.userInteraction.selectBox(selector, actualValue, index))
