...
describe("assertion - expectAttributeToContain", function () {
  ...
  it("Execution and Verification", async function () {
    await ui5.common.assertion.expectAttributeToContain(selector, "text", "to the Shopping Cart");
  });
});
...
describe("assertion - expectAttributeToContain with wrong attribute (unhappy case)", function () {
  ...
  it("Execution and Verification", async function () {
    await expect(ui5.common.assertion.expectAttributeToContain(selector, 123, "to the Shopping Cart"))
      .rejects.toThrow("attribute.toLowerCase is not a function");
    await expect(ui5.common.assertion.expectAttributeToContain(selector, false, "to the Shopping Cart"))
      .rejects.toThrow("javascript error: done is not a function");
    await expect(ui5.common.assertion.expectAttributeToContain(selector, null, "to the Shopping Cart"))
      .rejects.toThrow("javascript error: done is not a function");
    await expect(ui5.common.assertion.expectAttributeToContain(selector, undefined, "to the Shopping Cart"))
      .rejects.toThrow("javascript error: done is not a function");
  });
});
...
describe("assertion - expectAttributeToContain with wrong compareValue (unhappy case)", function () {
  ...
  it("Execution and Verification", async function () {
    await expect(ui5.common.assertion.expectAttributeToContain(selector, "text", 123))
