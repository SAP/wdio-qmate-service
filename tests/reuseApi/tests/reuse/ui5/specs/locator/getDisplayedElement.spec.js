...
describe("locator - 'getDisplayedElement' by selector and index", function () {
  ...
  it("Execution", async function () {
    ...
    elementOne = await ui5.common.locator.getDisplayedElement(selectorForMultipleElements, 0);
    elementTwo = await ui5.common.locator.getDisplayedElement(selectorForMultipleElements, 1);
  });
...
describe("locator - getDisplayedElement by wrong index (unhappy case)", function () {
  ...
  it("Execution and Verification", async function () {
    await expect(ui5.common.locator.getDisplayedElement(selectorForKeyboardsListElement, 111))
...
describe("locator - getDisplayedElement by wrong selector (unhappy case)", function () {
  ...
  it("Execution and Verification", async function () {
    ...
    await expect(ui5.common.locator.getDisplayedElement(wrongSelector))
...
describe("locator - getDisplayedElement by index which is equal to the number of elements on a page (unhappy case)", function () {
  ...
  it("Execution and Verification", async function () {
    ...
    await expect(ui5.common.locator.getDisplayedElement(searchFieldSelector, 1))
