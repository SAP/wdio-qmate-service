...
describe("userInteraction - clearAndFillActive", function () {
  ...
  it("Execution", async function () {
    ...
    await ui5.common.userInteraction.clearAndFillActive(value);
    ...
    valueAct = await ui5.common.locator.getValue(selector, attribute);
  });
...
describe("userInteraction - clearAndFillActive with wrong element", function () {
  ...
  it("Execution and Verification", async function () {
    ...
    await expect(ui5.common.userInteraction.clearAndFillActive(value))
