...
describe("userInteraction - click", function () {
  ...
  it("Verification", async function () {
    await ui5.common.assertion.expectUrlToBe("https://sapui5.hana.ondemand.com/1.99.0/#/api");
  });
});
...
describe("userInteraction - click on invisible element", function () {
  ...
  it("Preparation", async function () {
    await ui5.common.navigation.navigateToUrl("https://sapui5.hana.ondemand.com/1.99.0/test-resources/sap/m/demokit/cart/webapp/index.html?sap-ui-theme=sap_fiori_3#/category/AC/product/HT-6111");
    await handleCookiesConsent();
  });
