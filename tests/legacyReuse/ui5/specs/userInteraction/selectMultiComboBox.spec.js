...
describe("userInteraction - selectMultiComboBox", function () {
  ...
  it("Preparation", async function () {
    await ui5.common.navigation.navigateToUrl("https://sapui5.hana.ondemand.com/1.99.0/#/entity/sap.m.MultiComboBox/sample/sap.m.sample.MultiComboBox");
  ...
  it("Verification", async function () {
    ...
    await ui5.common.assertion.expectAttributeToBe(selector, "selectedKeys", expectedValue);
  });
});
...
describe("userInteraction - selectMultiComboBox (outside of a Viewport)", function () {
  ...
  it("Verification", async function () {
    ...
    await ui5.common.assertion.expectAttributeToBe(selector, "selectedKeys", valueExp);
  });
});
...
describe("userInteraction - selectMultiComboBox use wrong selector", function () {
  ...
  it("Execution and Verification", async function () {
    ...
    value1 = "Astro Phone 6";
    value2 = "Astro Laptop 1516";
    await expect(ui5.common.userInteraction.selectMultiComboBox(selector, [value1, value2]))
...
describe("userInteraction - selectMultiComboBox with index > 0", function () {
  ...
  it("Preparation", async function () {
    await ui5.common.navigation.navigateToUrl("https://sapui5.hana.ondemand.com/1.99.0/#/entity/sap.m.MultiComboBox/sample/sap.m.sample.MultiComboBoxSuggestionsAndValueState");
  ...
  it("Execution", async function () {
    ...
    await ui5.common.userInteraction.selectMultiComboBox(selector, [firstMultiComboValue1, firstMultiComboValue2], firstIndex);
    secondMultiComboValue1 = "CD/DVD case: 264 sleeves";
    secondMultiComboValue2 = "Cepat Tablet 8";
    await ui5.common.userInteraction.selectMultiComboBox(selector, [secondMultiComboValue1, secondMultiComboValue2], secondIndex);
  });

  it("Verification of values in first MultiComboBox", async function () {
    firstMultiComboExpectedValue = "HT-1252,HT-1251";
    await ui5.common.assertion.expectAttributeToBe(selector, "selectedKeys", firstMultiComboExpectedValue, firstIndex);
  });

  it("Verification of values in second MultiComboBox", async function () {
    secondMultiComboExpectedValue = "HT-2025,HT-1258";
    await ui5.common.assertion.expectAttributeToBe(selector, "selectedKeys", secondMultiComboExpectedValue, secondIndex);
  });
});