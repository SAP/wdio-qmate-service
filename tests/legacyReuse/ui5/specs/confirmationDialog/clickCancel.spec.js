...
describe("confirmationDialog - clickCancel", function () {
  it("Preparation", async function () {
    ...
    await ui5.common.userInteraction.click(productForPutToCart);
    ...
    await ui5.common.userInteraction.click(cartButton);
    ...
    await ui5.common.userInteraction.click(editCartButton);
    ...
    await ui5.common.userInteraction.click(removeButton);
  ...
  it("Verification", async function () {
    ...
    await ui5.common.assertion.expectToBeVisible(cartWithOneItem);
    ...
    await expect(ui5.common.locator.getDisplayedElement(selectorForPopup)).rejects.toThrow(/uiControlExecuteLocator\(\): No visible elements found/);
  });
});
...
describe("confirmationDialog - clickCancel without confirmation dialog (unhappy case)", function () {
  ...
  it("Execution and Verification", async function () {
    await expect(ui5.common.confirmationDialog.clickCancel())
