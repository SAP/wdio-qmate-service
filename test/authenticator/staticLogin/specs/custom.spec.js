...
describe("loginCustom", function () {
  ...
  it("Execution", async function () {
    await ui5.session.loginCustom("PURCHASER", "super-duper-sensitive-pw", "#username", "#password", "#logon", false);
  });
...
describe("loginCustom - error case", function () {
  ...
  it("Execution and Verification", async function () {
    await expect(ui5.session.loginCustom("PURCHASER", "super-duper-sensitive-pw", "#wrongusernamefield", "#wrongpasswordfield", "#wrongsubmitbutton", false))
