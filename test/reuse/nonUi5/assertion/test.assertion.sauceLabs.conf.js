...
exports.config = merge(profile.config, {
  ...
  specs: [path.resolve(__dirname, "expectToBeVisible.spec.js"), path.resolve(__dirname, "expectValueToBe.spec.js"), path.resolve(__dirname, "expectToBeNotVisible.spec.js"), path.resolve(__dirname, "expectAttributeToBe.spec.js"), path.resolve(__dirname, "expectAttributeToContain.spec.js")],
