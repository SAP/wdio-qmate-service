...
describe("getAssociationProperty - 'ariaDescribedBy' of Button", function () {
  ...
  it("Preparation", async () => {
    const url = "https://sapui5.hana.ondemand.com/1.120.1/#/entity/sap.m.Button/sample/sap.m.sample.Button";
...
describe("getAssociationProperty - 'selectedItems' of MultiComboBox", function () {
  ...
  it("Preparation", async () => {
    const url = "https://sapui5.hana.ondemand.com/1.120.1/#/entity/sap.m.MultiComboBox/sample/sap.m.sample.MultiComboBox";
    await common.navigation.navigateToUrl(url);
    await handleCookiesConsent();
    selector = {
