...
describe("getAggregationProperty - columns of table", async () => {
  ...
  it("Preparation", async () => {
    const url = "https://sapui5.hana.ondemand.com/1.120.1/#/entity/sap.m.Table/sample/sap.m.sample.Table";
    await common.navigation.navigateToUrl(url);
...
describe("getAggregationProperty - items in list", async () => {
  ...
  it("Preparation", async () => {
    const url = "https://sapui5.hana.ondemand.com/1.120.1/#/entity/sap.m.Select/sample/sap.m.sample.Select";
    await common.navigation.navigateToUrl(url);
    await handleCookiesConsent();
  });
