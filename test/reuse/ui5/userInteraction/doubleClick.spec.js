...
describe("userInteraction - doubleClick", function () {
  ...
  it("Verification", async function () {
    await common.assertion.expectUrlToBe("https://sapui5.hana.ondemand.com/1.120.1/#/api");
  });
});
...
describe("userInteraction - doubleClick on invisible element", function () {
  ...
  it("Preparation", async function () {
    await common.navigation.navigateToUrl("https://sapui5.hana.ondemand.com/1.120.1/test-resources/sap/m/demokit/cart/webapp/index.html?sap-ui-theme=sap_fiori_3#/category/AC/product/HT-2000");
    await handleCookiesConsent();
  });
