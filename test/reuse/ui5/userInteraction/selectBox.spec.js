...
describe("userInteraction - selectBox", function () {
  ...
  it("Preparation", async function () {
    await common.navigation.navigateToUrl("https://sapui5.hana.ondemand.com/1.120.1/#/entity/sap.m.Select/sample/sap.m.sample.Select");
...
describe("userInteraction - use 3rd selectBox on page", function () {
  ...
  it("Preparation", async function () {
    await common.navigation.navigateToUrl("https://sapui5.hana.ondemand.com/1.120.1/#/entity/sap.m.Select/sample/sap.m.sample.SelectValueState");
    await handleCookiesConsent();
