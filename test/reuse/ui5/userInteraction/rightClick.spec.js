...
describe("userInteraction - rightClick", function () {
  ...
  it("Verification", async function () {
    await common.assertion.expectUrlToBe("https://ui5.sap.com/");
...
describe("userInteraction - rightClick on invisible element", function () {
  ...
  it("Preparation", async function () {
    await common.navigation.navigateToUrl("https://ui5.sap.com/test-resources/sap/m/demokit/cart/webapp/index.html?sap-ui-theme=sap_fiori_3?sap-ui-theme=sap_fiori_3#/category/AC/product/HT-6111");
    await handleCookiesConsent();
  });
