...
describe("userInteraction - rightClick", function () {
  ...
  it("Preparation", async function () {
    await browser.navigateTo("https://sapui5.hana.ondemand.com/1.120.1/");
  ...
  it("Verification", async function () {
    await common.assertion.expectUrlToBe("https://sapui5.hana.ondemand.com/1.120.1/");
...
describe("userInteraction - rightClick on invisible element", function () {
  ...
  it("Preparation", async function () {
    await common.navigation.navigateToUrl("https://sapui5.hana.ondemand.com/1.120.1/test-resources/sap/m/demokit/cart/webapp/index.html?sap-ui-theme=sap_fiori_3?sap-ui-theme=sap_fiori_3#/category/AC/product/HT-6111");
    await handleCookiesConsent();
  });
