...
describe("userInteraction - select", function () {
  ...
  it("Execution", async function () {
    ...
    await ui5.userInteraction.select(selector, actualValue, index);
  });
...
describe("userInteraction - select use wrong selector", function () {
  ...
  it("Execution & Verification", async function () {
    ...
    actualValue = "HT-1003";
    index = 0;
    await expect(ui5.userInteraction.select(selector, actualValue, index))
      .rejects.toThrow(/uiControlExecuteLocator\(\): No visible elements found/);
  });
});

describe("userInteraction - select use wrong value", function () {
