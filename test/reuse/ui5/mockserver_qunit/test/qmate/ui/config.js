...
exports.config = merge(plainConfig.config, {
  ...
  params: {
    ...
    coverage: {
      status: false,
      coverage_files: ["Component.js", "controller", "!test", "!localService", "!test-resources", "!resources"],
  ...
  specs: [path.resolve(__dirname, "qunitExecution/specs/runQUnitTests.spec.js"), path.resolve(__dirname, "testDisplayNotFound/specs/testDisplayNotFound.spec.js"), path.resolve(__dirname, "testShowEmployeeList/specs/testShowEmployeeList.spec.js")]
});
