...
describe("date - pickRange - when DateRangeSelection do not have any value", function () {
  ...
  it("Preparation", async function () {
    await browser.url("https://sapui5.hana.ondemand.com/1.120.1/#/entity/sap.m.DateRangeSelection/sample/sap.m.sample.DateRangeSelectionValueState");
...
describe("date - pickRange without datePiker (unhappy case)", function () {
  ...
  it("Preparation", async function () {
    await browser.url("https://sapui5.hana.ondemand.com/1.120.1/test-resources/sap/m/demokit/cart/webapp/index.html?sap-ui-theme=sap_fiori_3#/categories");
  });
