...
describe("date - pickRange - when DateRangeSelection do not have any value", function () {
  ...
  it("Preparation", async function () {
    ...
    await browser.url("https://ui5.sap.com/1.132.1/#/entity/sap.m.DateRangeSelection/sample/sap.m.sample.DateRangeSelectionValueState");
...
describe("date - pickRange without datePiker (unhappy case)", function () {
  ...
  it("Preparation", async function () {
    await browser.url("https://ui5.sap.com/test-resources/sap/m/demokit/cart/webapp/index.html?sap-ui-theme=sap_fiori_3#/categories");
  });
