...
describe("confirmationDialog - clickButton - text 'OK'", function () {
  it("Preparation", async function () {
    await browser.navigateTo("https://sapui5.hana.ondemand.com/1.120.1/#/entity/sap.m.Input/sample/sap.m.sample.InputChecked");
...
describe("confirmationDialog - clickButton - text 'Cancel'", function () {
  it("Preparation", async function () {
    await browser.navigateTo("https://sapui5.hana.ondemand.com/1.120.1/#/entity/sap.m.MessageBox/sample/sap.m.sample.MessageBox");
    await handleCookiesConsent();
