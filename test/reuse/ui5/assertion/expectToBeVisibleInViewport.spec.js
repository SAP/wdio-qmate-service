...
describe("assertion - expectToBeVisibleInViewport with element outside viewport (unhappy case)", function () {
  ...
  it("Verification", async function () {
    await expect(ui5.assertion.expectToBeVisibleInViewport(selector, 0, 2500)).rejects.toThrow("Function 'expectToBeVisibleInViewport' failed: Given Selector was not in the Viewport.");
  });
});
