...
exports.config = merge(chromeConfig.config, {
  ...
  specs: [path.resolve(__dirname, "specs/import.spec.js"), path.resolve(__dirname, "specs/export.spec.js"), path.resolve(__dirname, "specs/export.slow.spec.js"), path.resolve(__dirname, "specs/export.fast.spec.js")],
