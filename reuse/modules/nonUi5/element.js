...
const Element = function () {
   ...
   */
  this.waitForAll = async function (selector, timeout = process.env.QMATE_CUSTOM_TIMEOUT.qmateCustomTimeout | 30000) {
    let elems = null;
    try {
   ...
   */
  this.waitToBePresent = async function (selector, timeout = process.env.QMATE_CUSTOM_TIMEOUT.qmateCustomTimeout | 30000) {
    let elem = null;
    await browser.waitUntil(async function () {
      elem = await $(selector);
   ...
   */
  this.waitToBeVisible = async function (selector, timeout = process.env.QMATE_CUSTOM_TIMEOUT.qmateCustomTimeout | 30000) {
    let elem = null;
    await browser.waitUntil(async function () {
      elem = await $(selector);
      if (!elem) return false;
   ...
   */
  this.waitToBeClickable = async function (selector, timeout = process.env.QMATE_CUSTOM_TIMEOUT.qmateCustomTimeout | 30000) {
    let elem = null;
    await browser.waitUntil(async function () {
      elem = await $(selector);
      if (!elem) return false;
   ...
   */
  this.getAllDisplayed = async function (selector, timeout = process.env.QMATE_CUSTOM_TIMEOUT.qmateCustomTimeout | 30000) {
    try {
   ...
   */
  this.getAll = async function (selector, timeout = process.env.QMATE_CUSTOM_TIMEOUT.qmateCustomTimeout | 30000) {
    let elems = null;
    let count = null;
    try {
      await browser.waitUntil(async function () {
   ...
   */
  this.getByCss = async function (selector, index = 0, timeout = process.env.QMATE_CUSTOM_TIMEOUT.qmateCustomTimeout | 30000) {
    try {
      await this.waitForAll(selector, timeout);
   ...
   */
  this.getByCssContainingText = async function (selector, text = "", index = 0, timeout = process.env.QMATE_CUSTOM_TIMEOUT.qmateCustomTimeout | 30000) {
    try {
   ...
   */
  this.getById = async function (id, timeout = process.env.QMATE_CUSTOM_TIMEOUT.qmateCustomTimeout | 30000) {
    try {
   ...
   */
  this.getByClass = async function (elemClass, index = 0, timeout = process.env.QMATE_CUSTOM_TIMEOUT.qmateCustomTimeout | 30000) {
    try {
   ...
   */
  this.getByName = async function (name, index = 0, timeout = process.env.QMATE_CUSTOM_TIMEOUT.qmateCustomTimeout | 30000) {
    try {
   ...
   */
  this.getByXPath = async function (xpath, index = 0, timeout = process.env.QMATE_CUSTOM_TIMEOUT.qmateCustomTimeout | 30000) {
    try {
   ...
   */
  this.getByChild = async function (elementSelector, childSelector, index = 0, timeout = process.env.QMATE_CUSTOM_TIMEOUT.qmateCustomTimeout | 30000) {
    let elems;
    try {
   ...
   */
  this.getByParent = async function (elementSelector, parentSelector, index = 0, timeout = process.env.QMATE_CUSTOM_TIMEOUT.qmateCustomTimeout | 30000) {
    let parentElems = [];
    try {
   ...
   */
  this.isPresentByCss = async function (css, index = 0, timeout = process.env.QMATE_CUSTOM_TIMEOUT.qmateCustomTimeout | 30000) {
    try {
      let elements;
   ...
   */
  this.isPresentByXPath = async function (xpath, index = 0, timeout = process.env.QMATE_CUSTOM_TIMEOUT.qmateCustomTimeout | 30000) {
  ...
  async function _filterDisplayed(selector, index = 0, timeout = process.env.QMATE_CUSTOM_TIMEOUT.qmateCustomTimeout | 30000) {
    let elems = null;
