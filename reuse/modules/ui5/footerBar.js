...
const FooterBar = function () {
   ...
   */
  this.clickButton = async function (text, timeout = process.env.QMATE_CUSTOM_TIMEOUT.qmateCustomTimeout | 30000) {
   ...
   */
  this.clickApply = async function (timeout = process.env.QMATE_CUSTOM_TIMEOUT.qmateCustomTimeout | 30000) {
   ...
   */
  this.clickSave = async function (timeout = process.env.QMATE_CUSTOM_TIMEOUT.qmateCustomTimeout | 30000) {
   ...
   */
  this.clickCreate = async function (timeout = process.env.QMATE_CUSTOM_TIMEOUT.qmateCustomTimeout | 30000) {
   ...
   */
  this.clickCancel = async function (timeout = process.env.QMATE_CUSTOM_TIMEOUT.qmateCustomTimeout | 30000) {
   ...
   */
  this.clickCheck = async function (timeout = process.env.QMATE_CUSTOM_TIMEOUT.qmateCustomTimeout | 30000) {
   ...
   */
  this.clickOrder = async function (timeout = process.env.QMATE_CUSTOM_TIMEOUT.qmateCustomTimeout | 30000) {
   ...
   */
  this.clickPost = async function (timeout = process.env.QMATE_CUSTOM_TIMEOUT.qmateCustomTimeout | 30000) {
   ...
   */
  this.clickAdd = async function (timeout = process.env.QMATE_CUSTOM_TIMEOUT.qmateCustomTimeout | 30000) {
