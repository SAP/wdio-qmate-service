...
const Element = function () {
   ...
   */
  this.getDisplayed = async function (selector, index = 0, timeout = process.env.QMATE_CUSTOM_TIMEOUT.qmateCustomTimeout | 30000) {
    if (!selector) {
   ...
   */
  this.getByText = async function (selector, value, index = 0, timeout = process.env.QMATE_CUSTOM_TIMEOUT.qmateCustomTimeout | 30000) {
   ...
   */
  this.getId = async function (selector, index = 0, timeout = process.env.QMATE_CUSTOM_TIMEOUT.qmateCustomTimeout | 30000) {
   ...
   */
  this.getPropertyValue = async function (selector, property, index = 0, timeout = process.env.QMATE_CUSTOM_TIMEOUT.qmateCustomTimeout | 30000) {
    try {
      const elem = await this.getDisplayed(selector, index, timeout);
   ...
   */
  this.getValue = async function (selector, index = 0, timeout = process.env.QMATE_CUSTOM_TIMEOUT.qmateCustomTimeout | 30000) {
    try {
   ...
   */
  this.getBindingValue = async function (selector, bindingContext, index = 0, timeout = process.env.QMATE_CUSTOM_TIMEOUT.qmateCustomTimeout | 30000) {
    const elem = await this.getDisplayed(selector, index, timeout);
   ...
   */
  this.isVisible = async function (selector, index = 0, timeout = process.env.QMATE_CUSTOM_TIMEOUT.qmateCustomTimeout | 30000) {
    try {
