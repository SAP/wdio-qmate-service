...
const UserInteraction = function () {
   ...
   */
  this.click = async function (selector, index = 0, timeout = process.env.QMATE_CUSTOM_TIMEOUT.qmateCustomTimeout | 30000) {
    let elem = null;
   ...
   */
  this.clickAndRetry = async function (selector, index = 0, timeout = process.env.QMATE_CUSTOM_TIMEOUT.qmateCustomTimeout | 30000, retries = 3, interval = 5000) {
   ...
   */
  this.clickTab = async function (selector, index = 0, timeout = process.env.QMATE_CUSTOM_TIMEOUT.qmateCustomTimeout | 30000) {
   ...
   */
  this.clickListItem = async function (selector, index = 0, timeout = process.env.QMATE_CUSTOM_TIMEOUT.qmateCustomTimeout | 30000) {
   ...
   */
  this.fill = async function (selector, value, index = 0, timeout = process.env.QMATE_CUSTOM_TIMEOUT.qmateCustomTimeout | 30000) {
    if (value !== null) {
   ...
   */
  this.fillAndRetry = async function (selector, value, index = 0, timeout = process.env.QMATE_CUSTOM_TIMEOUT.qmateCustomTimeout | 30000, retries = 3, interval = 5000) {
   ...
   */
  this.clear = async function (selector, index = 0, timeout = process.env.QMATE_CUSTOM_TIMEOUT.qmateCustomTimeout | 30000) {
   ...
   */
  this.clearAndRetry = async function (selector, index = 0, timeout = process.env.QMATE_CUSTOM_TIMEOUT.qmateCustomTimeout | 30000, retries = 3, interval = 5000) {
   ...
   */
  this.clearAndFill = async function (selector, value, index = 0, timeout = process.env.QMATE_CUSTOM_TIMEOUT.qmateCustomTimeout | 30000) {
    if (value !== null) {
   ...
   */
  this.clearAndFillAndRetry = async function (selector, value, index = 0, timeout = process.env.QMATE_CUSTOM_TIMEOUT.qmateCustomTimeout | 30000, retries = 3, interval = 5000, verify = true) {
   ...
   */
  this.clearSmartFieldInput = async function (selector, index = 0, timeout = process.env.QMATE_CUSTOM_TIMEOUT.qmateCustomTimeout | 30000) {
   ...
   */
  this.clearAndFillSmartFieldInput = async function (selector, value, index = 0, timeout = process.env.QMATE_CUSTOM_TIMEOUT.qmateCustomTimeout | 30000) {
    const id = await ui5.element.getId(selector, index, timeout);
   ...
   */
  this.clearAndFillSmartFieldInputAndRetry = async function (selector, value, index = 0, timeout = process.env.QMATE_CUSTOM_TIMEOUT.qmateCustomTimeout | 30000, retries = 3, interval = 5000) {
   ...
   */
  this.scrollToElement = async function (selector, index = 0, alignment = "center", timeout = process.env.QMATE_CUSTOM_TIMEOUT.qmateCustomTimeout | 30000) {
    const elem = await ui5.element.getDisplayed(selector, index, timeout);
    if (elem) {
      const options = {
        "block": alignment,
   ...
   */
  this.selectAll = async function (selector, index = 0, timeout = process.env.QMATE_CUSTOM_TIMEOUT.qmateCustomTimeout | 30000) {
   ...
   */
  this.openF4Help = async function (selector, index = 0, timeout = process.env.QMATE_CUSTOM_TIMEOUT.qmateCustomTimeout | 30000, useF4Key = true) {
   ...
   */
  this.searchFor = async function (selector, value, index = 0, timeout = process.env.QMATE_CUSTOM_TIMEOUT.qmateCustomTimeout | 30000, useEnter = true) {
   ...
   */
  this.resetSearch = async function (selector, index = 0, timeout = process.env.QMATE_CUSTOM_TIMEOUT.qmateCustomTimeout | 30000) {
    const id = await ui5.element.getId(selector, index, timeout);
  ...
  // =================================== HELPER ===================================
  async function _clearHelper(selector, index = 0, timeout = process.env.QMATE_CUSTOM_TIMEOUT.qmateCustomTimeout | 30000) {
    let id, elem;
    if (selector) {
      await ui5.userInteraction.click(selector, index, timeout);
   ...
   */
  this.doubleClick = async function (selector, index = 0, timeout = process.env.QMATE_CUSTOM_TIMEOUT.qmateCustomTimeout | 30000) {
    let elem = null;
    await browser.waitUntil(async function () {
      elem = await ui5.element.getDisplayed(selector, index, timeout);
      if (!elem) return false;
   ...
   */
  this.rightClick = async function (selector, index = 0, timeout = process.env.QMATE_CUSTOM_TIMEOUT.qmateCustomTimeout | 30000) {
    let elem = null;
    await browser.waitUntil(async function () {
      elem = await ui5.element.getDisplayed(selector, index, timeout);
      if (!elem) return false;
  ...
  //  */
  // this.dragAndDrop = async function (sourceSelector, targetSelector, sourceIndex = 0, targetIndex = 0, duration = 3000, timeout = process.env.QMATE_CUSTOM_TIMEOUT.qmateCustomTimeout | 30000) {
