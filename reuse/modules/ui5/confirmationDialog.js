...
const ConfirmationDialog = function () {
   ...
   */
  this.clickOk = async function (timeout = process.env.QMATE_CUSTOM_TIMEOUT.qmateCustomTimeout | 30000) {
   ...
   */
  this.clickYes = async function (timeout = process.env.QMATE_CUSTOM_TIMEOUT.qmateCustomTimeout | 30000) {
   ...
   */
  this.clickNo = async function (timeout = process.env.QMATE_CUSTOM_TIMEOUT.qmateCustomTimeout | 30000) {
   ...
   */
  this.clickDelete = async function (timeout = process.env.QMATE_CUSTOM_TIMEOUT.qmateCustomTimeout | 30000) {
   ...
   */
  this.clickRevokeApproval = async function (timeout = process.env.QMATE_CUSTOM_TIMEOUT.qmateCustomTimeout | 30000) {
