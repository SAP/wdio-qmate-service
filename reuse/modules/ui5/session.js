...
const Session = function () {
   ...
   */
  this.login = async function (username, password = "Welcome1!", verify = false, timeout = process.env.QMATE_CUSTOM_TIMEOUT | 30000) {
    if (!username) {
  ...
  // =================================== HELPER ===================================
  async function _loginWithUsernameAndPassword(username, password = "Welcome1!", authenticator = ui5.authenticators.fioriForm, verify = false, messageSelector) {
