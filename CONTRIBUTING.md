...
Contributors will be asked to accept a DCO before they submit the first pull request to this projects, this happens in an automated fashion during the submission process. SAP uses <a href="https://developercertificate.org/" target="_blank">the standard DCO text of the Linux Foundation</a>
