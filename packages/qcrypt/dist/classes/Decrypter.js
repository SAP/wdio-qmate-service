...
class Decrypter {
    ...
    static decryptDataForAvailableKey(data, decryptionOptions, printOptions) {
        ...
        const privateKey = this.retrievePrivateKey(path_1.default.resolve(__dirname, "../../../.."));
     ...
     * @returns Private key.
     */
    static retrievePrivateKey(dirname) {
        let privateKey;
        try {
            ...
            if (process.env.QMATE_PRIVATE_KEY) {
                ...
                try {
                    privateKey = fs_1.default.readFileSync(path_1.default.resolve(dirname, common_1.PRIVATE_KEY_NAME), "utf8");
                }
                catch (error) {
