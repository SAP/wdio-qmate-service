...
export class ElementModule {
   ...
   */
  async getDisplayed(selector: any, index = 0, timeout: number = ): Promise<Element> {
   ...
   */
  async getByText(selector: any, value: string, index = 0, timeout: number = ): Promise<Element> {
   ...
   */
  async getByChild(elementSelector: any, childSelector: any, index = 0, timeout: number = ): Promise<Element> {
    const vl = this.vlf.initLog(this.getByText);
    const selector = {
   ...
   */
  async getByParent(elementSelector: any, parentSelector: any, index = 0, timeout: number = ): Promise<Element> {
   ...
   */
  async getId(selector: any, index = 0, timeout: number = ): Promise<string> {
   ...
   */
  async getPropertyValue(selector: any, property: string, index = 0, timeout: number = ): Promise<any> {
   ...
   */
  async getValue(selector: any, index = 0, timeout: number = ): Promise<string> {
   ...
   */
  async getCssPropertyValue(selector: any, cssProperty: string, index = 0, timeout: number = ): Promise<string> {
   ...
   */
  async getBindingValue(selector: any, bindingContext: string, index = 0, timeout: number = ): Promise<string> {
   ...
   */
  async isVisible(selector: any, index = 0, timeout: number = ): Promise<boolean> {
