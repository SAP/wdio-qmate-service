...
export class FooterBar {
   ...
   */
  async clickApply(timeout: number = ) {
   ...
   */
  async clickSave(timeout: number = ) {
   ...
   */
  async clickCreate(timeout: number = ) {
   ...
   */
  async clickCancel(timeout: number = ) {
   ...
   */
  async clickCheck(timeout: number = ) {
   ...
   */
  async clickOrder(timeout: number = ) {
   ...
   */
  async clickPost(timeout: number = ) {
