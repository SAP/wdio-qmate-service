...
export class Control {
   ...
   * @param {Element | Ui5Selector | Ui5SelectorOptions} selectorOrElement - The selector object, selector with options (selector, index, timeout) or the dom element (retrieved from ui5.element.getDisplayed).
   ...
   * }, selector, args);
   **/
  async execute (callbackFunction: Function, selectorOrElement: Element | Ui5Selector | Ui5SelectorOptions, args?: any) {
   ...
   **/
  async getProperty (selectorOrElement: Element | Ui5Selector | Ui5SelectorOptions, propertyName: string) {
   ...
   **/
  async getAggregationProperty (selectorOrElement: Element | Ui5Selector | Ui5SelectorOptions, propertyName: string) {
   ...
   **/
  async getAssociationProperty (selectorOrElement: Element | Ui5Selector | Ui5SelectorOptions, propertyName: string) {
   ...
   **/
  async getBindingContextPathProperty (selectorOrElement: Element | Ui5Selector | Ui5SelectorOptions) {
   ...
   **/
  async getPropertyBinding (selectorOrElement: Element | Ui5Selector | Ui5SelectorOptions, propertyName: string) {
