...
export class Data {
   ...
   */
  decrypt(data: string | Array<string>, options: { useBase64Input: false; useBase64Output: false; includeRepoUrl: true }): string {
  ...
  private _decryptRecursively(data: any, options?: { useBase64Input: false; useBase64Output: false; includeRepoUrl: true }): any {
