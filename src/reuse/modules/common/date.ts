...
export class DateModule {
   ...
   */
  getToday(format: DateFormatsType = process.env.USER_SETTINGS_DATE_FORMAT as DateFormats.OBJECT): Date | string {
   ...
   */
  getTomorrow(format: DateFormatsType = process.env.USER_SETTINGS_DATE_FORMAT as DateFormats.OBJECT): Date | string {
   ...
   */
  getNextMonth(format: DateFormatsType = process.env.USER_SETTINGS_DATE_FORMAT as DateFormats.OBJECT): Date | string {
    const vl = this.vlf.initLog(this.getTomorrow);
    const date = new Date();
   ...
   */
  getPreviousMonth(format: DateFormatsType = process.env.USER_SETTINGS_DATE_FORMAT as DateFormats.OBJECT): Date | string {
   ...
   */
  getNextYear(format: DateFormatsType = process.env.USER_SETTINGS_DATE_FORMAT as DateFormats.OBJECT): Date | string {
   ...
   */
  getPreviousYear(format: DateFormatsType = process.env.USER_SETTINGS_DATE_FORMAT as DateFormats.OBJECT): Date | string {
   ...
   */
  getSpecific(date: string, format: DateFormatsType = process.env.USER_SETTINGS_DATE_FORMAT as DateFormats.OBJECT): Date | string {
   ...
   */
  calculate(date: CalculateDatesType = CalculateDates.TODAY, format: DateFormatsType = process.env.USER_SETTINGS_DATE_FORMAT as DateFormats.OBJECT): Date | string {
