...
export class ElementModule {
   ...
   * @param {String} selector - The CSS selector describing the element.
   * @param {Number} [timeout=30000] - The timeout to wait (ms).
   * @example await nonUi5.element.waitForAll(".inputField");
   */
  async waitForAll(selector: string, timeout: number = parseFloat(process.env.QMATE_CUSTOM_TIMEOUT!) || GLOBAL_DEFAULT_WAIT_TIMEOUT, includeHidden: boolean = false): Promise<void> {
   ...
   */
  async waitToBePresent(selector: any, timeout: number = parseFloat(process.env.QMATE_CUSTOM_TIMEOUT!) || GLOBAL_DEFAULT_WAIT_TIMEOUT): Promise<void> {
   ...
   */
  async waitToBeVisible(selector: any, timeout: number = parseFloat(process.env.QMATE_CUSTOM_TIMEOUT!) || GLOBAL_DEFAULT_WAIT_TIMEOUT) {
   ...
   */
  async waitToBeClickable(selector: any, timeout: number = parseFloat(process.env.QMATE_CUSTOM_TIMEOUT!) || GLOBAL_DEFAULT_WAIT_TIMEOUT) {
   ...
   */
  async getAllDisplayed(selector: any, timeout: number = parseFloat(process.env.QMATE_CUSTOM_TIMEOUT!) || GLOBAL_DEFAULT_WAIT_TIMEOUT): Promise<WebdriverIO.Element[]> {
    ...
    try {
      ...
      const elems: WebdriverIO.ElementArray = await $$(selector).getElements();
   ...
   */
  async getAll(selector: any, timeout: number = parseFloat(process.env.QMATE_CUSTOM_TIMEOUT!) || GLOBAL_DEFAULT_WAIT_TIMEOUT): Promise<WebdriverIO.Element[]> {
    const vl = this.vlf.initLog(this.getAll);
    try {
      await this.waitForAll(selector, timeout, true);
      vl.log(`Getting elements by selector ${selector}`);
      const elems = await $$(selector).getElements();
   ...
   */
  async getByCss(selector: any, index: number = 0, timeout: number = parseFloat(process.env.QMATE_CUSTOM_TIMEOUT!) || GLOBAL_DEFAULT_WAIT_TIMEOUT, includeHidden: boolean = false): Promise<WebdriverIO.Element> {
   ...
   */
  async getByCssContainingText(selector: any, text: string = "", index: number = 0, timeout: number = parseFloat(process.env.QMATE_CUSTOM_TIMEOUT!) || GLOBAL_DEFAULT_WAIT_TIMEOUT, includeHidden: boolean = false, strict: boolean = false): Promise<WebdriverIO.Element> {
   ...
   */
  async getById(id: string, timeout: number = parseFloat(process.env.QMATE_CUSTOM_TIMEOUT!) || GLOBAL_DEFAULT_WAIT_TIMEOUT, includeHidden: boolean = false): Promise<WebdriverIO.Element> {
    const vl = this.vlf.initLog(this.getById);
    try {
      const selector = `[id='${id}']`;
      if (includeHidden) {
        await this.waitToBePresent(selector, timeout);
        return await $(selector).getElement();
      } else {
   ...
   */
  async getByClass(elemClass: string, index: number = 0, timeout: number = parseFloat(process.env.QMATE_CUSTOM_TIMEOUT!) || GLOBAL_DEFAULT_WAIT_TIMEOUT, includeHidden: boolean = false): Promise<WebdriverIO.Element> {
   ...
   */
  async getByName(name: string, index: number = 0, timeout: number = parseFloat(process.env.QMATE_CUSTOM_TIMEOUT!) || GLOBAL_DEFAULT_WAIT_TIMEOUT, includeHidden: boolean = false): Promise<WebdriverIO.Element> {
   ...
   */
  async getByXPath(xpath: string, index: number = 0, timeout: number = parseFloat(process.env.QMATE_CUSTOM_TIMEOUT!) || GLOBAL_DEFAULT_WAIT_TIMEOUT, includeHidden: boolean = false) {
   ...
   */
  async getByChild(elementSelector: any, childSelector: any, index: number = 0, timeout: number = parseFloat(process.env.QMATE_CUSTOM_TIMEOUT!) || GLOBAL_DEFAULT_WAIT_TIMEOUT, includeHidden: boolean = false): Promise<WebdriverIO.Element> {
    ...
    const elementsWithChild: WebdriverIO.Element[] = [];
    for await (const element of elems) {
   ...
   */
  async getByParent(elementSelector: any, parentSelector: any, index: number = 0, timeout: number = parseFloat(process.env.QMATE_CUSTOM_TIMEOUT!) || GLOBAL_DEFAULT_WAIT_TIMEOUT, includeHidden: boolean = false): Promise<WebdriverIO.Element> {
    const vl = this.vlf.initLog(this.getByParent);
    let parentElems: WebdriverIO.Element[] = [];
    try {
    ...
    for (const parentElement of parentElems) {
      const elem = await parentElement.$(elementSelector).getElement();
      const toBeIncluded = includeHidden ? await elem.isExisting() : await elem.isDisplayed();
      if (toBeIncluded) {
   ...
   */
  async isPresent(elem: WebdriverIO.Element): Promise<boolean> {
   ...
   */
  async isPresentByCss(css: string, index: number = 0, timeout: number = parseFloat(process.env.QMATE_CUSTOM_TIMEOUT!) || GLOBAL_DEFAULT_WAIT_TIMEOUT) {
   ...
   */
  async isPresentByXPath(xpath: string, index: number = 0, timeout: number = parseFloat(process.env.QMATE_CUSTOM_TIMEOUT!) || GLOBAL_DEFAULT_WAIT_TIMEOUT): Promise<boolean> {
   ...
   */
  async getAttributeValue(elem: WebdriverIO.Element, attribute?: string): Promise<string> {
   ...
   */
  async getValue(elem: WebdriverIO.Element): Promise<string> {
   ...
   */
  async setInnerHTML(elem: WebdriverIO.Element, value: string): Promise<void> {
   ...
   */
  async highlight(elem: WebdriverIO.Element, duration: number = 2000, color: string = "red") {
  ...
  // =================================== HELPER ===================================
  private async _waitForStabilization(selector: string, timeout: number = parseFloat(process.env.QMATE_CUSTOM_TIMEOUT!) || GLOBAL_DEFAULT_WAIT_TIMEOUT, includeHidden: boolean = false, stableIterationsRequired: number = 3): Promise<void> {
  ...
  private async _getAndFilterElementBySelector(selector: string, index: number = 0, timeout: number = parseFloat(process.env.QMATE_CUSTOM_TIMEOUT!) || GLOBAL_DEFAULT_WAIT_TIMEOUT, includeHidden: boolean = false): Promise<WebdriverIO.Element> {
  ...
  private async _filterByText(elems: WebdriverIO.Element[] | WebdriverIO.ElementArray, text: string, strict: boolean = false) {
  ...
  private async _filterDisplayed(elems: WebdriverIO.Element[] | WebdriverIO.ElementArray) {
