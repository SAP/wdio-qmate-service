...
export class ElementModule {
   ...
   */
  async waitToBeVisible(selector: any, timeout: number = ) {
   ...
   */
  async waitToBeClickable(selector: any, timeout: number = ) {
   ...
   */
  async getAll(selector: any, timeout: number = ): Promise<Element[]> {
   ...
   */
  async getByCss(selector: any, index: number = 0, timeout: number = , includeHidden: boolean = false): Promise<Element> {
   ...
   */
  async getByCssContainingText(selector: any, text: string = "", index: number = 0, timeout: number = , includeHidden: boolean = false, strict: boolean = false): Promise<Element> {
   ...
   */
  async getById(id: string, timeout: number = , includeHidden: boolean = false): Promise<Element> {
   ...
   */
  async getByClass(elemClass: string, index: number = 0, timeout: number = , includeHidden: boolean = false): Promise<Element> {
   ...
   */
  async getByName(name: string, index: number = 0, timeout: number = , includeHidden: boolean = false): Promise<Element> {
   ...
   */
  async getByXPath(xpath: string, index: number = 0, timeout: number = , includeHidden: boolean = false) {
   ...
   */
  async getByChild(elementSelector: any, childSelector: any, index: number = 0, timeout: number = , includeHidden: boolean = false): Promise<Element> {
   ...
   */
  async getByParent(elementSelector: any, parentSelector: any, index: number = 0, timeout: number = , includeHidden: boolean = false): Promise<Element> {
  ...
  // =================================== HELPER ===================================
  private async _waitForStabilization(selector: object, timeout: number = , includeHidden: boolean = false, stableIterationsRequired: number = 3): Promise<void> {
  ...
  private async _getAndFilterElementBySelector(selector: string, index: number = 0, timeout: number = , includeHidden: boolean = false): Promise<Element> {
